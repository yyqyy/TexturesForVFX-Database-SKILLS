...
ALIASES: dict[str, tuple[str, ...]] = {
    ...
    "法阵": ("magic", "symbol", "circle", "rune", "sigil", "material maker"),
    "魔法阵": ("magic", "symbol", "circle", "rune", "sigil", "material maker"),
    "符文": ("rune", "symbol", "magic", "material maker"),
    "magic circle": ("magic circle", "symbol", "rune", "sigil", "material maker"),
